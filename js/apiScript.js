...
document.getElementById("Outputnames").innerHTML= "current visible asteroids : none";
/////////////////////////////////////

// three.js scene building
let scene = new THREE.Scene();
scene.background = new THREE.Color(0x103044);
...
renderer.setSize(window.innerWidth*0.999, window.innerHeight*0.995);
...
function getData(e) {  
  ...
  .then(function(resp) {        
    ...
    document.getElementById("Outputnames").innerHTML="current visible asteroids : <br>"+names;
  })      
  .catch(function(resp) {      
